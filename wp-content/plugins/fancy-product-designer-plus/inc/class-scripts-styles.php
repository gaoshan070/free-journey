...
if(!class_exists('FPD_Plus_Scripts_Styles')) {
	...
	class FPD_Plus_Scripts_Styles {
		...
		public function register() {
			...
			$plus_js_url = Fancy_Product_Designer_Plus::LOCAL ? 'http://radykal.dev/fpd/dist/plus/FancyProductDesignerPlus.js' : plugins_url( '/js/FancyProductDesignerPlus.min.js', dirname(__FILE__) );
