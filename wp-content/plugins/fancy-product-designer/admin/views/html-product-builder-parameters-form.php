			...
			<table class="form-table">
				<tbody>
					...
					<tr>
						...
						<td class="radykal-radio-group-inline">
							<label><input type="radio" name="advancedEditing" value="1" /> <?php _e('Yes', 'radykal'); ?></label>
							<label><input type="radio" name="advancedEditing" value="0" checked="checked" /> <?php _e('No', 'radykal'); ?></label>
						</td>
					</tr>
				</tbody>
			</table>
