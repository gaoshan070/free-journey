...
if(!class_exists('FPD_Pricing_Scripts_Styles')) {
	...
	class FPD_Pricing_Scripts_Styles {
		...
		public function register() {
			...
			$js_url = Fancy_Product_Designer_Pricing::LOCAL ? 'http://radykal.dev/fpd/dist/addons/pricing_rules/FPDPricingRules.js' : plugins_url( '/js/FPDPricingRules.min.js', dirname(__FILE__) );
