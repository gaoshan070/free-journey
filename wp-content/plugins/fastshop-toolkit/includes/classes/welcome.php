	...
	class Fastshop_Welcome
	{
		...
		public function set_tabs()
		{
			$this->tabs = array(
				...
				'demos'     => esc_html__( 'Sample Data', 'fastshop-toolkit' ),
            ...
            <div class="dashboard">
                ...
                <div class="dashboard-intro">
                    ...
                    <div class="intro">
                        ...
                        <h2>Quick Setings</h2>
                        <ul>
                            <li><a href="admin.php?page=fastshop_menu&tab=demos">Install Demos</a></li>
		...
		public static function demos()
		{
			if ( class_exists( 'FASTSHOP_IMPORTER' ) ) {
				$fastshop_importer = new FASTSHOP_IMPORTER();
				$fastshop_importer->importer_page_content();
			}
		}
