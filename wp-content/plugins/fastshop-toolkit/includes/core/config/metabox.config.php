		...
		array(
			...
			'fields' => array(
				...
				array(
					...
					'title'   => 'Rating',
					'options' => array(
						'1' => get_template_directory_uri() . '/assets/images/1star.png',
						'2' => get_template_directory_uri() . '/assets/images/2star.png',
						'3' => get_template_directory_uri() . '/assets/images/3star.png',
						'4' => get_template_directory_uri() . '/assets/images/4star.png',
						'5' => get_template_directory_uri() . '/assets/images/5star.png',
					),
					'default' => '',
				),
				array(
