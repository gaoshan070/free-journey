...
if ( !class_exists( 'Fastshop_PluginLoad' ) ) {
	class Fastshop_PluginLoad
	{
		...
		public function plugins()
		{
			$this->plugins = array(
				array(
					'name'               => 'fastshop-importer', // The plugin name
					'slug'               => 'fastshop-importer', // The plugin slug (typically the folder name)
					'source'             => esc_url( 'http://kutethemes.net/wordpress/plugins/fastshop-importer.zip' ), // The plugin source
				...
				array(
					...
					'source'             => esc_url( 'http://kutethemes.net/wordpress/plugins/fastshop-toolkit.zip' ), // The plugin source
					'required'           => true, // If false, the plugin is only 'recommended' instead of required
