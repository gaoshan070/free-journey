...
if ( !function_exists( 'fastshop_resize_image' ) ) {
	...
	{
		$img_lazy = get_theme_file_uri( 'assets/images/1x1.jpg' );
		...
		if ( !empty( $actual_file_path ) && file_exists( $actual_file_path ) ) {
			...
			if ( $image_src[ 1 ] > $width || $image_src[ 2 ] > $height ) {
				...
				if ( file_exists( $cropped_img_path ) ) {
					...
					if ( $use_lazy == true ) {
						$vt_image[ 'img' ] = '<img class="lazy owl-lazy" src="' . esc_url( $img_lazy ) . '" data-src="' . esc_url( $cropped_img_url ) . '" data-original="' . esc_url( $cropped_img_url ) . '" width="' . esc_attr( $width ) . '" height="' . esc_attr( $height ) . '" alt="">';
					}
				...
				if ( $crop == false ) {
					...
					if ( file_exists( $resized_img_path ) ) {
						...
						if ( $use_lazy == true ) {
							$vt_image[ 'img' ] = '<img class="lazy owl-lazy" src="' . esc_url( $img_lazy ) . '" data-src="' . esc_url( $resized_img_url ) . '" data-original="' . esc_url( $resized_img_url ) . '" width="' . esc_attr( $proportional_size[ 0 ] ) . '" height="' . esc_attr( $proportional_size[ 1 ] ) . '" alt="">';
						}
				...
				if ( $use_lazy == true ) {
					$vt_image[ 'img' ] = '<img class="lazy owl-lazy" src="' . esc_url( $img_lazy ) . '" data-src="' . esc_url( $new_img ) . '" data-original="' . esc_url( $new_img ) . '" width="' . esc_attr( $new_img_size[ 0 ] ) . '" height="' . esc_attr( $new_img_size[ 1 ] ) . '" alt="">';
				}
			...
			if ( $use_lazy == true ) {
				$vt_image[ 'img' ] = '<img class="lazy owl-lazy" src="' . esc_url( $img_lazy ) . '" data-src="' . esc_url( $image_src[ 0 ] ) . '" data-original="' . esc_url( $image_src[ 0 ] ) . '" width="' . esc_attr( $image_src[ 1 ] ) . '" height="' . esc_attr( $image_src[ 2 ] ) . '" alt="">';
			}
			...
			$vt_image = array(
				...
				'width'  => $width,
				'height' => $height,
				'img'    => '<img src="' . esc_url( 'http://placehold.it/' . $width . 'x' . $height ) . '" width="' . esc_attr( $width ) . '" height="' . esc_attr( $height ) . '" alt="">',
			);
