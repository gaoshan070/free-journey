...
if ( empty( $data_meta ) ) {
	/*Default page layout*/
	$fastshop_page_extra_class = '';
	$fastshop_page_layout      = 'left';
	$fastshop_page_sidebar     = 'widget-area';
} else {
	/*Default page layout*/
	$fastshop_page_extra_class = $data_meta[ 'page_extra_class' ];
	$fastshop_page_layout      = $data_meta[ 'sidebar_page_layout' ];
	$fastshop_page_sidebar     = $data_meta[ 'page_sidebar' ];
}
