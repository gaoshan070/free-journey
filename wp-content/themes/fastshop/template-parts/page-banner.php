...
if ( isset( $data_meta ) && !empty( $data_meta ) ) {
	$fastshop_metabox_enable_banner  = $data_meta[ 'fastshop_metabox_enable_banner' ];
	$fastshop_page_header_background = $data_meta[ 'bg_banner_page' ];
	$fastshop_page_heading_height    = $data_meta[ 'height_banner' ];
	$fastshop_page_margin_top        = $data_meta[ 'page_margin_top' ];
	$fastshop_page_margin_bottom     = $data_meta[ 'page_margin_bottom' ];
	$css                             = '';
} else {
	return;
}
