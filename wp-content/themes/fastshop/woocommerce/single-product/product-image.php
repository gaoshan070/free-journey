...
$single_product_sidebar = fastshop_get_option( 'sidebar_product_position', 'left' );
    ...
    <div class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?>"
        ...
        <figure class="woocommerce-gallery-carousel woocommerce-product-gallery__wrapper">
			...
			if ( has_post_thumbnail() ) {
				...
				$html .= sprintf( '<img src="%s" alt="%s" class="wp-post-image" />', esc_url( wc_placeholder_img_src() ), esc_html__( 'Awaiting product image', 'fastshop' ) );
				$html .= '</div>';
			}
...
<?php elseif ( $style_single_product == 'style-with-thumbnail' ) : ?>
    <div class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?>"
         data-columns="<?php echo esc_attr( $columns ); ?>" style="opacity: 0; transition: opacity .25s ease-in-out;">
        <figure class="woocommerce-gallery-carousel woocommerce-product-gallery__wrapper">
			<?php
