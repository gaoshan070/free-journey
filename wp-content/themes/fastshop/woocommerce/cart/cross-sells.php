...
$woo_crosssell_ls_items = fastshop_get_option( 'fastshop_woo_crosssell_ls_items', 3 );
$woo_crosssell_lg_items = fastshop_get_option( 'fastshop_woo_crosssell_lg_items', 3 );
$woo_crosssell_md_items = fastshop_get_option( 'fastshop_woo_crosssell_md_items', 3 );
$woo_crosssell_sm_items = fastshop_get_option( 'fastshop_woo_crosssell_sm_items', 2 );
$woo_crosssell_xs_items = fastshop_get_option( 'fastshop_woo_crosssell_xs_items', 1 );
$woo_crosssell_ts_items = fastshop_get_option( 'fastshop_woo_crosssell_ts_items', 1 );
...
$woo_cross_sell_title = fastshop_get_option( 'fastshop_cross_sells_products_title', 'You may be interested in...' );
